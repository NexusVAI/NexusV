const articleData = {
    hero: {
        overlay: 'NexusV',
        media: { type: 'video', src: 'Logo/NEXUSV.mp4', poster: 'Logo/NEXUSV.webp', fit: 'cover', alt: 'NexusV V5' },
        zh: {
            title: '介绍 NexusV V5',
            date: '2026年3月30日',
            category: '产品',
    ...
    news3: {
        ...
        zh: {
            ...
            paragraphs: [
                ...
                '1. 定义与产品说明',
                '1.1 "本套件"指由开发者发布的 NexusV 系列内容，当前包括：（1）TACTFR：用于 GTA V 单机离线环境的警务玩法增强模组；（2）NexusV 修改器：用于 GTA V 单机离线环境的数值与体验调整工具；（3）Sentience：用于 GTA V 游戏内 NPC 对话生成与互动增强的 AI 模组。',
                ...
                '1.6 "第三方组件"指本套件中嵌入或引用的由其他作者/组织提供的库、工具或二进制文件（详见第 3 节）。',
