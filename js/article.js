const articleData = {
    hero: {
        media: { type: 'video', src: 'Logo/HORE1.mp4', alt: 'Sentience Demo Video' },
        zh: {
            title: '赋予洛圣都数字灵魂',
    ...
    n1: {
        ...
        en: {
            title: 'Introducing Sentience V3.1',
            date: 'March 02, 2026',
    ...
    n3: {
        ...
        en: {
            ...
            readTime: '3 min read',
            paragraphs: [
                'NexusV V4 unifies security policies and experience into the same interaction structure.',
                'This is a placeholder article used to continue the reading path after clicking the card on the home page.',
                'Later extensions: table of contents, quote blocks, code blocks, figure captions, more media, etc.'
            ]
        }
    },
    news1: {
    ...
    news6: {
        ...
        zh: {
            title: '深入了解 — 隆重推出 Sentience V3.1',
        ...
        en: {
            title: 'Deep Dive — Introducing Sentience V3.1',
            date: 'March 02, 2026',
            category: 'Product',
...
function initIndexPage() {
    ...
    function renderIndex(lang) {
        // Scrollable List (n1, n2, n3)
        if (scrollableList) {
            scrollableList.innerHTML = '';
            // n1 points to news6 (Sentience V3.1 article)
            const listIds = ['n1', 'n2', 'n3'];
            const linkTargets = ['news6', 'n2', 'n3']; // n1 links to news6
        ...
        if (newsGrid) {
            newsGrid.innerHTML = '';
            ['news1', 'news2', 'news3', 'news4', 'news5', 'news6', 'news7', 'news8'].forEach(id => {
                const item = articleData[id];
                if (!item) return;
                const data = item[lang] || item.zh;
                const card = document.createElement('a');
