        ...
        <div class="footer-inner">
            <div class="footer-grid">
                <div class="footer-column">
                    ...
                    <a href="${base}/article.html?id=tactfr627" data-i18n="footer.research_overview">研究概述</a>
            ...
            <div class="footer-bottom">
                <nav class="footer-socials" aria-label="社交链接">
                    ...
                    <a href="https://discord.gg/BD9M6VMu" target="_blank" rel="noopener noreferrer" aria-label="Discord" title="Discord">
                    ...
                    <a href="https://huggingface.co/xingy555888" target="_blank" rel="noopener noreferrer" aria-label="Hugging Face" title="Hugging Face">
                        <img class="social-icon social-icon--huggingface" src="${base}/chat/huggingface-color.svg" alt="" width="20" height="20" loading="lazy" decoding="async">
                    </a>
                    <a href="https://space.bilibili.com/3691002594331274" target="_blank" rel="noopener noreferrer" aria-label="Bilibili" title="Bilibili">
                        <img class="social-icon social-icon--bilibili" src="${base}/chat/bilibili-color.svg" alt="" width="20" height="20" loading="lazy" decoding="async">
                    </a>
                </nav>
                ...
                <div class="bottom-right">
                    ...
                    <button class="theme-toggle" id="theme-toggle" aria-label="切换主题">
                        ...
                        <svg class="blue-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:none;">
