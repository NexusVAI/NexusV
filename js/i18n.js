const translations = {
    'zh': {
        ...
        // 2026-07-10: 旗舰卡价格与 Neon model_pricing 对齐（勿手写过期价；i18n 会覆盖 HTML 默认文案）。
        'api.home.card.opus.spec1': '输入：¥1.60 / 输出：¥5.00 每百万标记',
        'api.home.card.opus.spec2': '20万 上下文长度 · 3.2万 最大输出',
        'api.home.card.opus.spec3': '知识截止日期：2026年1月',
        'api.home.card.gpt56sol.spec1': '输入：¥0.15 / 输出：¥0.80 每百万标记',
        'api.home.card.gpt56sol.spec2': '40万 上下文长度 · 3.2万 最大输出',
        'api.home.card.gpt56sol.spec3': '知识截止日期：2025年12月',
        // 兼容旧 key（若别处仍引用）
        'api.home.card.gpt55.spec1': '输入：¥0.15 / 输出：¥0.80 每百万标记',
        'api.home.card.gpt55.spec2': '40万 上下文长度 · 3.2万 最大输出',
        'api.home.card.gpt55.spec3': '知识截止日期：2025年12月',
        'api.home.card.grok.spec1': '输入：¥0.10 / 输出：¥0.10 每百万标记',
        'api.home.card.grok.spec2': '25.6万 上下文长度 · 3.2万 最大输出',
        ...
        'api.home.enterprise.security.l1': '对话数据训练开关由你掌控，一键即可退出',
        'api.home.enterprise.security.l2': '聊天记录可手动删除，支持账户注销与数据清理',
        'api.home.enterprise.security.l3': '多层风控与访问审计，识别并拦截异常登录和滥用',
        'api.home.enterprise.security.l4': 'Cloudflare 边缘安全网关 + Neon 安全托管数据库',
        'api.home.enterprise.security.l5': '数据存储位置透明，主数据库部署于新加坡',
        'api.home.enterprise.security.l6': 'IP 维度风控与登录频率保护，实时识别异常来源',
        'api.home.enterprise.security.l7': '邮箱 OTP 无密码登录，JWT 无状态鉴权',
        'api.home.enterprise.security.l8': '全站 HTTPS 传输加密（TLS 1.3），云端存储加密保护',
    ...
    'en': {
        ...
        // 2026-07-10: flagship card prices aligned to Neon model_pricing.
        'api.home.card.opus.spec1': 'Input: ¥1.60 / Output: ¥5.00 per 1M tokens',
        'api.home.card.opus.spec2': '200K context · 32K max output',
        'api.home.card.opus.spec3': 'Knowledge cutoff: Jan 2026',
        'api.home.card.gpt56sol.spec1': 'Input: ¥0.15 / Output: ¥0.80 per 1M tokens',
        'api.home.card.gpt56sol.spec2': '400K context · 32K max output',
        'api.home.card.gpt56sol.spec3': 'Knowledge cutoff: Dec 2025',
        'api.home.card.gpt55.spec1': 'Input: ¥0.15 / Output: ¥0.80 per 1M tokens',
        'api.home.card.gpt55.spec2': '400K context · 32K max output',
        'api.home.card.gpt55.spec3': 'Knowledge cutoff: Dec 2025',
        'api.home.card.grok.spec1': 'Input: ¥0.10 / Output: ¥0.10 per 1M tokens',
        'api.home.card.grok.spec2': '256K context · 32K max output',
        ...
        'api.home.enterprise.security.l1': 'Your data training preference is under your control — opt out with one click',
        'api.home.enterprise.security.l2': 'Chat history can be manually deleted; account deletion is supported',
        'api.home.enterprise.security.l3': 'Multi-layer risk control and access auditing to detect abuse',
        'api.home.enterprise.security.l4': 'Cloudflare edge security gateway with Neon managed database',
        'api.home.enterprise.security.l5': 'Transparent data location: primary database in Singapore',
        ...
        'api.home.enterprise.security.l8': 'Full-site HTTPS encryption (TLS 1.3) with encrypted cloud storage',
