/* Trusted-by logo row — 5 logos visible at once, grayscale (OpenAI layout). */
(function (global) {
  "use strict";
  ...
  function isVaiLogo(path) {
    return /VAI-logo\.svg$/i.test(path || "");
  }

  function createVaiMark(url) {
    var wrap = document.createElement("div");
    wrap.className = "trusted-logos__inner trusted-logos__inner--vai";
  ...
  function createTextLogo(url) {
    var wrap = document.createElement("div");
    wrap.className = "trusted-logos__inner trusted-logos__inner--wide";
    var img = document.createElement("img");
    img.className = "trusted-logos__img";
    img.src = url;
    img.alt = "";
    img.decoding = "async";
    img.loading = "lazy";
  ...
  function buildSlot(colIndex, path, assetBase) {
    ...
    slot.appendChild(isVaiLogo(path) ? createVaiMark(url) : createTextLogo(url));
    return slot;
  }
