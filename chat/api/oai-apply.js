 ...
 * 后端仅存 `purpose` 自由文本）。本页把"可选的联系人/公司 + 营销订阅勾选"
 * 一并编入 purpose，使其随申请记录持久化（营销订阅状态预留后用）。
 * 业务需求为必填；其余非必填。 */
(function () {
  "use strict";
