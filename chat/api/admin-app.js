...
// ─── 2026-08-18 晚：Opus5 验证用户面板 + 批量清零 已整段删除 ───────────────
// Opus5 免费期结束（站内 id 改名 claude-opus-5-thinking、按次 ¥0.099），
// 验证用户机制与免费额度一并取消。原有内容：OPUS5_MATCHES 状态、renderOpus5Row /
// renderOpus5Table / searchOpus5Candidates / setOpus5Verified / resetOpus5DailyLimits，
// 以及它们的三个后端端点（admin_search_opus5_candidates / admin_set_opus5_verified /
// admin_reset_opus5_daily_limits）—— 端点已在网关侧删除，留着调用只会 400。
// admin.html 里对应的 #opus5VerifyCard 面板也已移除。
